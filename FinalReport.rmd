...
colPerc(table1)
```
Taking a look from a graph to numerical results, we can see that the numbers supported the earlier statement, of the drug isnt working and is causing Females to catch aids.  
